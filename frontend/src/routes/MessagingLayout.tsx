...
import messagesLeafMark from "@/assets/messages-leaf-mark.svg";
        ...
        {isSidebarCollapsed ? (
          ...
          <>
            ...
            <nav className="mt-4 flex shrink-0 flex-wrap gap-2 border-t border-neutral-200 pt-4 [&>p]:w-full [&>p]:text-sm [&>p]:text-danger-700">
              <Link
                className="flex min-w-0 flex-1 items-center justify-center rounded-md px-3 py-2 text-sm font-medium text-neutral-700 transition-colors hover:bg-white hover:text-neutral-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600"
                to="/profile"
              >
                My profile
              </Link>
